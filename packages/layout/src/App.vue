...
export default {
  ...
  created() {
    ...
    IMSDK.login({
      lt: 'eyJhcHBJZCI6IjYzNmNhMzFiZDRjYTM1MmJmMWZmNjQxZSIsImFwcFVzZXIiOiIyMzQ1IiwiZXhwaXJlIjotMSwic2lnbiI6IlhmdkZ5VVJUMnU0YjZVaFYzSUU2ZjcvdHBTZ0NTRjlNTzVMaVBxV2x2NVE9In0=',
    })
      .then((e) => {
        if (e.code === 0) {
          console.log('登录成功');
